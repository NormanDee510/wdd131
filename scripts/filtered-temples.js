...
const temples = [
    ...
    },
    {
        ...
        location: "Austin Texas Oak Hills Stake, USA",
        dedicated: "2025, April, 13",
        area: 116642,
        imageUrl: "https://churchofjesuschristtemples.org/assets/img/temples/austin-texas-temple/austin-texas-temple-51660.jpg"
    },
    {
        templeName: "Anchorage-alaska-temple",
        location: "Anchorage Alaska North Stake, Alaska",
...
function displayTemples() {
    ...
    temples.forEach(temple => {
        ...
        templeDiv.classList.add("temple-item");
        ...
        templeGallery.appendChild(templeDiv);
    });
}
